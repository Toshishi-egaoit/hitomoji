...
- DBの構造を検討する。
- MySQLなどのRDBMSに入れて、クエリを投げる形で統計情報を得たりできるようにする。

## v0.3.2

目的：漢字をキーボードにマッピングするしくみのけんとう

- ｍ4などのマクロ処理ツールを用いて、DBから必要な情報を抽出して、ひともじの辞書形式に変換するロジックを作る。
- 実際の辞書構造の検討
- 位置の重複が起きないように、漢字をキーボードにマッピングするロジックの検討

## v0.3.3

目的：辞書メンテツールの作成

- 内容未定。作者専用か、公開かも含めて未定

## v0.3.4

目的：辞書の作成

- メンテツールを用いて、漢字辞書を作成する。
- 当面の目標は、教育漢字の辞書を作成すること。
